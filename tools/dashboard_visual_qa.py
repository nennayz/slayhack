...
def _page_checks(root: Path, mission_path: str | None = None) -> list[PageCheck]:
    ...
    checks = [
        ...
        PageCheck("ebooks", "/aurora/ebooks", ("E-book Product Factory", "Age Like Fine Wine", "designed_pdf_ready", "Drive source verification", "Verified artifacts", "Live publish and checkout stay locked", "QA certification")),
        PageCheck(
            "crew",
            "/aurora/crew",
...
def _css_checks(root: Path) -> dict[str, Any]:
    ...
    required_patterns = {
        ...
        "manual_learning_bridge_mobile": r"\.manual-learning-bridge",
